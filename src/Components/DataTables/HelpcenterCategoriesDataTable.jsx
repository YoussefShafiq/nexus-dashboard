...
export default function HelpcenterCategoriesDataTable({ helpcenterCategoriesData, loading, refetch }) {
    ...
    const handleToggleStatus = async (categoryId, currentStatus) => {
        ...
        try {
            await axios.patch(
                `https://api.nexus.com/api/admin/help-center/categories/${categoryId}/toggle-status`,
                {},
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            await axios.delete(
                `https://api.nexus.com/api/admin/help-center/categories/${categoryToDelete}`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
                    }
    ...
    const handleAddCategory = async (e) => {
        ...
        try {
            await axios.post(
                'https://api.nexus.com/api/admin/help-center/categories',
                {
                    name: formData.name,
    ...
    const handleUpdateCategory = async (e) => {
        ...
        try {
            await axios.put(
                `https://api.nexus.com/api/admin/help-center/categories/${selectedCategory.id}`,
                {
                    name: formData.name,
                    description: formData.description,
                    order: parseInt(formData.order),
