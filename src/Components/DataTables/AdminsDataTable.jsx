...
export default function AdminsDataTable({ admins, allPermissions, loading, refetch }) {
    ...
    const handleToggleStatus = async (adminId, currentStatus) => {
        ...
        try {
            ...
            await axios.patch(
                `https://api.nexus.com/api/admins/${adminId}/toggle-status`,
                { status: newStatus },
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            await axios.delete(
                `https://api.nexus.com/api/admins/${adminToDelete}`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
                    }
    ...
    const handleAddAdmin = async (e) => {
        ...
        try {
            await axios.post(
                'https://api.nexus.com/api/admins',
                {
                    name: formData.name,
    ...
    const handleUpdateAdmin = async (e) => {
        ...
        try {
            ...
            await axios.post(
                `https://api.nexus.com/api/admins/${selectedAdmin.id}`,
                payload,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
    ...
    const handleUpdatePermissions = async (e) => {
        ...
        try {
            await axios.put(
                `https://api.nexus.com/api/admins/${selectedAdmin.id}/permissions`,
                {
                    permissions: formData.permissions
                },
                {
