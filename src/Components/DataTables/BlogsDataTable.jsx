...
export default function BlogsDataTable({ blogs, loading, refetch }) {
    ...
    const { data: faqs, refetch: refetchFaqs } = useQuery({
        ...
        queryFn: () => {
            ...
            return axios.get(`https://api.nexus.com/api/admin/blogs/${currentBlogId}/manage/faq`, {
                headers: {
    ...
    const addFaqMutation = useMutation({
        mutationFn: (newFaq) => {
            return axios.post(
                `https://api.nexus.com/api/admin/blogs/${currentBlogId}/manage/faq`,
                newFaq,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
    ...
    const updateFaqMutation = useMutation({
        mutationFn: (updatedFaq) => {
            return axios.put(
                `https://api.nexus.com/api/admin/blogs/${currentBlogId}/manage/faq/${editingFaqId}`,
                updatedFaq,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
    ...
    const deleteFaqMutation = useMutation({
        mutationFn: (faqId) => {
            return axios.delete(
                `https://api.nexus.com/api/admin/blogs/${currentBlogId}/manage/faq/${faqId}`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
                    }
    ...
    const handleToggleStatus = async (blogId, currentStatus) => {
        ...
        try {
            await axios.patch(
                `https://api.nexus.com/api/admin/blogs/${blogId}/toggle-active`,
                {},
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            await axios.delete(
                `https://api.nexus.com/api/admin/blogs/${blogToDelete}`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
                    }
    ...
    const handleUpdateBlog = async (e) => {
        ...
        try {
            ...
            await axios.post(
                `https://api.nexus.com/api/admin/blogs/${editFormData.id}`,
                formDataToSend,
                {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('userToken')}`,
    ...
    const confirmBulkDelete = async () => {
        ...
        try {
            ...
            await axios.post('https://api.nexus.com/api/admin/blogs/bulk/delete',
                { ids: selectedBlogs },
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
    ...
    const handleBulkStatusUpdate = async (status) => {
        ...
        try {
            setIsBulkActionLoading(true);
            await axios.post('https://api.nexus.com/api/admin/blogs/bulk/update-status',
                {
                    ids: selectedBlogs,
                    status: status
                },
