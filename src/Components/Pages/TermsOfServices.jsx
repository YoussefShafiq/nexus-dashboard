...
export default function TermsOfServices() {
    ...
    const handleSave = async () => {
        setIsSaving(true);
        try {
            const response = await axios.post('https://api.nexus.com/api/admin/legal-documents/terms-of-service', {
    ...
    const { data, isLoading, refetch, error, isError } = useQuery({
        ...
        queryFn: () => {
            return axios.get('https://api.nexus.com/api/legal-documents/terms-of-service')
        }
    })
